...
{ 
 ...
 {      
  ...
  $mail->Username="admin@radoncosmos.in";  
  $mail->Password="Rashmi@siku1509";            
  $mail->SetFrom('admin@radoncosmos.in','Radoncosmos Quiz Portal');
  $mail->AddReplyTo("admin@radoncosmos.in","Radoncosmos");
